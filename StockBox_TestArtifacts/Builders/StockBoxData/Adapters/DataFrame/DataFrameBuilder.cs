...
namespace StockBox_TestArtifacts.Builders.StockBoxData.Adapters.DataFrame
{
    public class DataFrameBuilder
    {
        ...
        public DataFrameBuilder WithCloseAndIndicator(DateTime? date = null, int? close = null, IndicatorDataPoint indicator = null)
        {
            _dataPoints.Add(new MockDataPoint(date, null, null, null, close, null, null, new List<IndicatorDataPoint>() { indicator }));
            return this;
        }

        public DataFrameBuilder WithData(DateTime? date = null, double? high = null, double? low = null, double? open = null, double? close = null, double? adjClose = null, double? volume = null, List<IndicatorDataPoint> indicators = null)
        {
            _dataPoints.Add(new MockDataPoint(date, high, low, open, close, adjClose, volume, indicators));
            return this;
        }

        public DataFrameBuilder WithData(DateTime? date = null, double? high = null, double? low = null, double? open = null, double? close = null, double? adjClose = null, double? volume = null, string indicatorKey = null, params object[] values)
        {
        ...
        public DataFrameBuilder WithData(DateTime? date = null, IndicatorDataPoint indicator = null)
        {
            _dataPoints.Add(new MockDataPoint(date, 0, 0, 0, 0, 0, 0, new List<IndicatorDataPoint>() { indicator }));
            return this;
        }

        public DataFrameBuilder WithData(DateTime? date = null, string key = null, params object[] values)
        {
            return WithData(date, indicator: new IndicatorDataPoint(key, values));
        }

        public T Build<T>() where T : IDataFrameAdapter, new()
        {
            var ret = new T();
